...
export default function Home() {
  ...
  const features = [
    {
      ...
      description: "Vi fokuserer på bevisstgjøring. Hvordan ivareta kropp, tanker og følelser."
    },
    {
      title: "Selvutvikling",
  ...
  const services = [
    {
      title: "Kurs",
      description: "Våre erfarne veiledere er dedikerte til å støtte deg på veien mot lykke og velvære. Se vårt nettkurs eller bestill skreddersydd til dere.",
      bgColor: "bg-[#3F7F94]",
    ...
    {
      title: "Foredrag",
      description: "Vi har foredrag om glede, helse og suksess hvor vi ønsker å formidle bevisstgjøring rundt eget tankesett, og den kraften du har i deg selv.",
      bgColor: "bg-[#4DA797]",
    ...
    {
      title: "Team-building",
      description: "Sammen skaper vi et trygt og støttende miljø hvor du kan utforske, lære og vokse for å oppnå en bedre hverdag, arbeidsmiljø og suksess.",
      bgColor: "bg-[#545454]",
  ...
  const visionCards = [
    ...
    {
      title: "Vårt fokus:",
      description: "Er å vise deg nøkkelen til å forstå deg selv bedre, slik at du får kraft og energi til å gjøre mer av det du ønsker.",
      icon: (
        <svg className="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="text-lg text-gray-700 leading-relaxed space-y-4">
                <p>
                  Vi som bevissthetsutviklere i BTBH har en helhetlig tilnærming til å styrke ditt velvære. Vårt team består av erfarne veiledere med relevant utdanning. Vi har mange års erfaring innen veiledning, coaching, ernæring, fysisk og mental helse.
                </p>
                
                <p>
                  Samarbeidet vårt fokuserer på å skape opphøyet glede i hverdagen, en større bevissthet og tro på kraften i deg selv. Vi har lest og lært om kroppen, psyken og mennesket som en helhet. Vi elsker å lære. Vi lærer konstant hver dag begge to, og det har vi gjort i over 40 år. I tillegg til skoler og kurs leser og hører vi på alt innenfor vårt interesseområde.
                </p>
                
                <p>
                  I og med vi har vært så trofaste mot dette i så mange år, har vi mye kunnskap. Nå vil vi gjerne dele med oss og hjelpe andre som vil lytte og lære til å bli mer bevisst på sitt indre. Du er mer kraftfull enn du tror. Slik vi ser det er det lurt å kjenne den kraften i deg, og kunne bruke den til å manifestere det du vil.
                </p>
              </div>
            </div>
